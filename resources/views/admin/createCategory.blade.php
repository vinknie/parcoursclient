...
<div class="grid grid-rows-3 grid-flow-col gap-4">
    ...
    @endif
        <form class="" action="{{ url('/dashboard/createCategory/createCat') }}" method="post" enctype="multipart/form-data">
            @csrf
    ...
    @endif
        <form class="" action="{{ url('/dashboard/createCategory/createVerba') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div>
